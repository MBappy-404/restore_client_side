                    ...
                    <div className="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style={{ maxWidth: '1000px' }}>
                         <div className="md:flex w-full">
                              ...
                              <div className="hidden md:block w-1/2 bg-indigo-500 py-10 px-10">
                                   <img src="https://cdni.iconscout.com/illustration/premium/thumb/account-login-4571935-3805756.png" className='mt-16' alt="" />
                              </div>
                                   ...
                                   <form onSubmit={handleSubmit(handleSignup)}>
                                        ...
                                        <div className="flex -mx-3">
                                             <div className="w-full px-3 mb-12">
                                                  ...
                                                  <small className='mt-5 flex justify-center text-sm'>New to Restore <span className='text-indigo-500 ml-3 font-bold'> <Link to='/signup'>Sign Up</Link> </span> </small>
                                             </div> 
