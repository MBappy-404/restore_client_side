    ...
    <div>
      <div className="container flex flex-col-reverse md:flex justify-center  p-6 mx-auto sm:py-5 lg:py-14 lg:flex-row lg:justify-evenly">
        ...
        <h1 className='text-2xl md:text-3xl text-indigo-500 font-semibold mb-3 '>About Us</h1>
          ...
          <p className="mt-2 mb-6 text-xs text-gray-700 md:text-lg">Restore has an extensive collection of new and used goods, making it easier for users to quickly buy new items or buy used items at their desired location. To buy online, users easily can reach their desired products through filtering options...</p>
          <div className="flex flex-col m-auto md:m-0 space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start">
            <button className='btn primary no-animation bg-indigo-800 w-40'>Learn More</button>
          </div>
        </div>
