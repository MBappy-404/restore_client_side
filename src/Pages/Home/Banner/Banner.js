  ...
  return (
    <div >
      <section  className=" bg-animated text-white">
        <div  className="container flex flex-col-reverse md:flex justify-center  p-6 mx-auto sm:py-12 lg:flex-row lg:justify-evenly">
          <div data-aos="zoom-in" className="flex flex-col  justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
            ...
            <p className="mt-2 mb-6 text-sm text-gray-300 md:text-lg">Restore is a platform on which you can buy and sell Laptop! We help people buy and sell Laptops for our customers.
            </p>
